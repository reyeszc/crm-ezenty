    ...
    <div className="max-w-3xl mx-auto pb-20 lg:pb-6">
      ...
      <div className="card overflow-hidden">
        ...
        <div className="px-6 py-3 border-t border-[var(--border)] flex items-center justify-between" style={{ background: "#F8F9FA" }}>
          <p className="text-xs text-[var(--text-muted)]">EZENTY ProCare LLC · {(cliente.zona || "").toLowerCase().includes("ga") || (cliente.zona || "").toLowerCase().includes("georgia") ? "Georgia" : "Tennessee"} · IICRC Certified</p>
          <div className="flex items-center gap-3">
